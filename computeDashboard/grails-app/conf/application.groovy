...
// Added by the Spring Security Core plugin:
grails.plugin.springsecurity.userLookup.userDomainClassName = 'computedashboard.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'computedashboard.UserRole'
grails.plugin.springsecurity.authority.className = 'computedashboard.Role'
grails.plugin.springsecurity.controllerAnnotations.staticRules = [
	'/':                ['permitAll'],
	'/error':           ['permitAll'],
	'/index':           ['permitAll'],
